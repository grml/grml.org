...
<?php include '../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h2>grml / grml-medium / grml-small 2009.05</h2>

        <p>The 2009.05 releases of grml provide kernel 2.6.28:</p>

<pre class="rahmen">
grml@grml ~ % uname -a
Linux grml 2.6.28-grml #1 SMP PREEMPT Mon May 4 07:40:22 UTC 2009 i686 GNU/Linux</pre>

        <p>The <a
        href="http://git.grml.org/?p=grml-kernel.git;a=blob;f=config/config-2.6.28-grml;hb=HEAD">kernel
        configuration of 2.6.28-grml</a> is available online.</p>

        <h2>grml64 / grml64-medium / grml64-small 2009.05</h2>

        <p>The 2009.05 64bit releases of grml provide kernel 2.6.28:</p>

<pre class="rahmen">
grml@grml ~ % uname -a
Linux grml 2.6.28-grml64 #1 SMP PREEMPT Mon May 4 10:55:15 UTC 2009 x86_64 GNU/Linux</pre>

        <p>The <a
        href="http://git.grml.org/?p=grml-kernel.git;a=blob;f=config/config-2.6.28-grml64;hb=HEAD">kernel
        configuration of 2.6.28-grml64</a> is available online.</p>

        <p>Notice: grml-small does not ship any further extra kernel
        packages besides the core kernel packages and lacks speakup
        support.</p>

        <h2><a name="patches"></a>Kernel Patches of 2.6.28-grml[64]</h2>

        <p>The kernel 2.6.28-grml[64] is based on 2.6.28.10. Find more
        information about the patches used in the grml-kernel <a
        href="http://git.grml.org/?p=grml-kernel.git;a=blob;f=2.6.28/README;hb=HEAD">in
        the grml-kernel repository</a>.</p>

        <h2><a name="modules"></a>Modules shipped with grml 2009.05</h2>
        ...
        <p>This driver supports PCI and CardBus wireless network cards with the
        Ralink RT2400 or RT2401 chipset.</p>

        <ul>
          <li><a href="http://rt2x00.serialmonkey.com/">rt2x00.serialmonkey.com</a></li>
        </ul>

        <h3>rt73</h3>

        <p>This driver supports USB wireless network cards with the Ralink
        RT2501USB chipset.</p>
        ...
        (virtualbox-ose-modules-2.6.28-grml) and the VirtualBox guest addition
        modules (virtualbox-ose-guest-modules-2.6.28-grml).</p>
