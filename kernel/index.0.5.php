...
<?php include '../static.inc'; ?>
      ...
      <div class="content">
        ...
        <p>Release 0.5 provides kernel 2.6.13:</p>

<pre class="rahmen">
grml@grml ~ % uname -a
Linux grml 2.6.13-grml #1 Sat Oct 22 11:05:29 CEST 2005 i686 GNU/Linux</pre>

         <p>The <a href="config-2.6.13-grml">kernel configuration of 2.6.13-grml</a>
         is available online. If you want to patch a vanilla kernel without applying
         all the single patches take a look at the <a
         href="http://dufo.tugraz.at/~prokop/grml-kernel/2.6.13-info/all-in-one-2.6.13-grml-7.gz">all-in-one
         kernel patch</a> (1.0MB).  Also take a look at the list of <a
         href="http://dufo.tugraz.at/~prokop/grml-kernel/2.6.13-info/patches.applied">applied
         patches</a>.</p>
...
Linux grml 2.6.12-grml #1 SMP Mon Jun 20 12:58:06 CEST 2005 i686 GNU/Linux</pre>
        ...
        <ul>
          <li><a href="http://dufo.tugraz.at/~prokop/grml-kernel/2.6.13-grml/">current kernel 2.6.13-grml</a></li>
        </ul>
        ...
        <ul>
          <li>2.6.13-rc7-libata1.patch: allows smartmontools to be used with the standard '-d ata' device type</li>
          <li>4300_via-vt6410.patch: add VIA VT6410 support
          <li>4355_promise-tx4200.patch: The Promise TX4200 is a 4-port SATA controller based on the PDC40519 chip. It meets the description of the 20319, so just a simple ID needs to be added to support this hardware.</li>
          ...
          <li>linux-2.6.13_pwc-10.0.8.patch: updated version of the Linux Philips USB Webcam driver [please notice the difference between the versions /lib/modules/2.6.13-grml/kernel/drivers/usb/media/pwc/pwc.ko (10.0.7-unofficial) and /lib/modules/2.6.13-grml/misc/pwc.ko (10.0.7a-debian)]</li>
          <li>usbvision_2.6.13.1.patch: driver for <a href="http://sourceforge.net/project/showfiles.php?group_id=27255">usbvision</a> (please notice: not yet tested)</li>
        </ul>

        <h3>Greg Kroah-Hartman</h3>

        <p>Fixes/Updates for 2.6.13: 2.6.13.4</p>

        <ul>
          <li><a href="http://kernel.org/pub/linux/kernel/v2.6/patch-2.6.13.4.bz2">patch-2.6.13.4.bz2</a></li>
        </ul>
        ...
        <ul>
          ...
          <li><a href="http://mppe-mppc.alphacron.de/">MPPE/MPPC kernel module for Linux</a></li>
        </ul>
        ...
        <ul>
          ...
          <li><a href="http://dev.gentoo.org/~dsd/genpatches/trunk/2.6.13/4900_speakup-20050825.patch">4900_speakup-20050825.patch</a>
        </ul>
        ...
        <ul>
          <li><a href="http://dev.gentoo.org/~dsd/genpatches/trunk/2.6.13/4705_squashfs-2.2.patch">4705_squashfs-2.2.patch</a></li>
        ...
        <ul>
          <li>dazuko: <a href="http://www.dazuko.org/">'Your Gateway to File Access
          Control'</a></li>
          <li>kqemu: <a
          href="http://fabrice.bellard.free.fr/qemu/qemu-accel.html">QEMU Accelerator
          Module</a> (with permission by Fabrice Bellard, thanks!), notice that a
          kqemu enabled debian package is available <a
          href="http://grml.org/repos/">in the grml-repos</a></li>
          <li>pcan: driver for low cost CAN-Hardware by Peak System by <a
          href="http://www.peak-system.com/linux/">Peak-System.com</a> [the grml-team
          uses this hardware in the <a href="http://www.robocup.tugraz.at/">Robocup-team @ TUG</a>]</li>
          <li>quickcam-messenger: <a href="http://home.mag.cx/messenger/">Logitech®
          QuickCam® Communicate</a> (notice:
          /lib/modules/2.6.13-grml/misc/quickcam.ko and
          /lib/modules/2.6.13-grml/misc/quickcam-messenger.ko have different
          srcversions)</li>
        </ul>
        ...
        <p>Linux driver for the Broadcom BCM4400 series Ethernet Network Controllers.
        Please notice that there exists another kernel module for the Broadcom
        BCM4400 controller namend 'b44' as well.</p>
        ...
        <p>Filesystem in USErspace. Simple interface for userspace programs to export
        a virtual filesystem to the linux kernel.</p>

        <ul>
          <li><a href="http://fuse.sourceforge.net/">fuse.sf.net</a></li>
        </ul>
...
<!--
        <p>Notice that <a
        href="http://people.redhat.com/pjones/ipw2200/broadcast.patch">broadcast.patch</a>
        and <a
        href="http://ieee80211.sourceforge.net/patches/ieee80211-1.0.3-skb_corrupt.patch">ieee80211-1.0.3-skb_corrupt.patch</a>
        have been applied against to driver to fix DHCP-problems with 2.6.13 and
        ipw2200.</p>
-->
