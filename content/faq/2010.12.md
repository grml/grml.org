+++
title = 'FAQ for Release 2010.12'
url = 'faq/2010.12.html'
icon = 'clanbomber'
+++
...
<h2 id="grml64"><a id="grmlmedium"></a><a id="grmlsmall"></a><a href="#toc">grml-medium / grml-small / grml64?</a></h2>
...
<h3 id="known_issues"><a id="release"></a><!-- old anchor --><a href="#toc">Are there any known issues with this release?</a></h3>

<p>We won't hide anything. Therefore, we do provide all known
issues/bugs publicly available: <a
href="https://github.com/grml/grml/wiki/grml_2010.12">issues regarding
