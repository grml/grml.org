...
<html>
<head>
<title>grml.org - Release Notes: grml 1.0 Meilenschwein</title>
<meta name="Title" content="grml.org - Release Notes: grml 1.0 Meilenschwein" />
...
<?php include '../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h1>Release Notes:<br />grml 1.0 - codename <a
        href="/faq/#releasename">Meilenschwein</a> (20070518)</h1>
	...
	of software and documentation on the CD.</p>
        ...
        href="http://wiki.grml.org/doku.php?id=grml_0.9">grml_0.9 @
        grml-wiki</a>.</p>
...
<pre class="rahmen">
  ...
  sysprof, tidev, tpm_emulator, truecrypt, unionfs
         ...
         found at the <a
         href="http://wiki.grml.org/doku.php?id=utf8">utf8 webpage in
         the grml-wiki</a>.</p>
...
<pre class="rahmen">
  ...
  xserver-xorg-input-void xserver-xorg-video-intel xsteg xwatchwin zfs-fuse zzuf
         ...
         <p>Take a look at <a
         href="http://wiki.grml.org/doku.php?id=grml_1.0">grml_1.0 @ grml-wiki</a>.
         ...
         check <a href="http://wiki.grml.org/doku.php?id=grml_1.0">grml_1.0 @
         ...
         in <a href="http://grml.org/user-survey/grml.txt">the grml user
