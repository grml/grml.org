...
<html>
<head>
<title>grml.org - Release Notes: grml-small 0.4 Springginckerl</title>
...
<?php include '../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h1>Release Notes:<br />grml-small 0.4-rc1 - codename <a
        href="/faq/#releasename">Springginckerl</a> (20070508)</h1>
	...
	yet the stable release!</strong></p>
        ...
        href="http://wiki.grml.org/doku.php?id=grml-small_0.3">grml-small_0.3
        @ grml-wiki</a>.</p>
...
<pre class="rahmen">
  ...
  most wipe
	 ...
	 <!--
         <p>Take a look at <a
         href="http://wiki.grml.org/doku.php?id=grml-small_0.4">grml_0.4-small
