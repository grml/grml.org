...
<?php include '../static.inc'; ?>
      ...
      <div class="content">
        ...
        <p>Release &gt;0.4 provides kernel 2.6.12:</p>

<pre class="rahmen">
grml@grml ~ % uname -a
Linux grml 2.6.12-grml #2 SMP Mon Jun 27 00:42:09 CEST 2005 i686 GNU/Linux</pre>

         <p>The <a href="config-2.6.12-grml">kernel configuration of 2.6.12-grml</a> is
         available online. If you want to patch a vanilla kernel without applying all
         the single patches take a look at the <a
         href="http://dufo.tugraz.at/~prokop/grml-kernel/2.6.12-info/all-in-one-2.6.12-grml-3">all-in-one
         kernel patch</a> (3.5MB).  Also take a look at the list of <a
         href="http://dufo.tugraz.at/~prokop/grml-kernel/2.6.12-info/patches.applied">applied
         patches</a>.</p>

        <h2><a name="links"></a>Links</h2>

        <ul>
          <li><a href="http://kernel.org/git/gitweb.cgi">gitweb</a> /
          <a href="http://ehlo.org/~kay/gitweb.pl/linux-2.6/log">gitweb</a></li>
          <li><a href="http://dev.gentoo.org/~dsd/gentoo-dev-sources/releases.htm">gentoo-dev-sources</a></li>
          <li><a href="http://dev.gentoo.org/~dsd/genpatches/trunk/2.6.12/">genpatches</a></li>
          <li><a href="ftp://ftp.de.kernel.org/pub/linux/kernel/v2.6/snapshots/incr/">incr-snapshots</a></li>
          <li><a href="http://sepi.be/nitro.php">nitro-patches</a></li>
          <li><a
          href="http://svn.debian.org/wsvn/kernel/trunk/kernel/source/kernel-source-2.6.12-2.6.12/?rev=0&sc=0">2.6.12@debian-svn</a></li>
          <li><a href="http://packages.debian.org/unstable/devel/kernel-patch-debian-2.6.12">kernel-patch-debian-2.6.12</a> <a href="http://packages.debian.org/unstable/devel/kernel-source-2.6.12">kernel-source-2.6.12</a></li>
        </ul>

<pre class="rahmen">
svn export svn://svn.debian.org/kernel/trunk/kernel/source/linux-2.6-2.6.12
svn co svn://svn.debian.org/svn/kernel/trunk/kernel/source/kernel-source-2.6.12-2.6.12</pre>

        <h2><a name="wishes"></a>Wishes/Requests</h2>

        <ul>
          <li><a href="http://robertk.com/source/">http://robertk.com/source/</a></li>
          <li><a href="http://sourceforge.net/project/showfiles.php?group_id=27255">usbvision</a></li>
          <li><a href="http://www.atconsultancy.nl/cowloop/">cowloop</a></li>
        </ul>

        <h2><a name="download"></a>Download</h2>

        <ul>
          <li><a href="http://dufo.tugraz.at/~prokop/grml-kernel/2.6.12-grml/">current kernel 2.6.12-grml</a></li>
        </ul>
...
<!--
        <ul>
          ...
          <li><a href="http://www.acm.cs.rpi.edu/dilinger/kernel-source-2.6.11/kernel-patch-debian-2.6.11_2.6.11-1_all.deb">drivers-add-scsi_changer.patch:</a> a device driver for scsi media changer devices (e.g. tape libraries)</li>
          <li><a href="http://www.acm.cs.rpi.edu/dilinger/kernel-source-2.6.11/kernel-patch-debian-2.6.11_2.6.11-1_all.deb">drivers-ide-dma-blacklist-toshiba.patch:</a> Blacklist "TOSHIBA CD-ROM XM-1702BC"</li>
          <li><a href="http://www.acm.cs.rpi.edu/dilinger/kernel-source-2.6.11/kernel-patch-debian-2.6.11_2.6.11-1_all.deb">drivers-media-video-v4l-mpeg-support.patch:</a> add an ioctl to set MPEG hardware encoder parameters on v4ldevices</li>
          <li><a href="http://www.acm.cs.rpi.edu/dilinger/kernel-source-2.6.11/kernel-patch-debian-2.6.11_2.6.11-1_all.deb">fs-asfs-2.patch:</a> support for the Amiga SmartFilesystem (asfs), 1.0beta9</li>
          <li><a href="http://www.acm.cs.rpi.edu/dilinger/kernel-source-2.6.11/kernel-patch-debian-2.6.11_2.6.11-1_all.deb">tty-locking-fixes9.patch:</a> small fix for serial_core.c</li>
        </ul>
-->

        <h3>Greg Kroah-Hartman</h3>

        <p>Fixes/Updates for 2.6.12: 2.6.12.3</p>

        <ul>
          <li><a href="http://kernel.org/pub/linux/kernel/v2.6/patch-2.6.12.3.bz2">patch-2.6.12.3.bz2</a></li>
        </ul>
...
-->
        ...
        <ul>
          <li><a href="ftp://ftp.kernel.org/pub/linux/kernel/people/akpm/patches/2.6/2.6.12-rc6/2.6.12-rc6-mm1/">reiser4 for 2.6.12-rc6-mm1</a></li>
