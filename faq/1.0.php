...
<?php include '../static.inc'; ?>
	...
	<p><strong>Up2date:</strong> 20071019 - applies to versions grml
	1.0 / grml64 0.1 / grml-small 0.4</p>
...
-->
        ...
        <p>Codename of grml 1.0 is Meilenschwein. 'Meilenstein' is german for
        milestone. Schwein is german word for pig/pork.  (Thanks for the idea
        to Frank '<a href="/team/#ft">ft</a>' Terbeck.)</p>

        <p>Codename of grml-small 0.4 is Springinkerl. Springinkerl as
        austrian word for an uneasy child.</p>

        <p>Codename of grml64 0.1 is LiveShell. grml64 is the 'shell of life'
        and can be used in Live mode.</p>
...
#</pre>
        ...
        about 215 software packages, lacks documentation and manpages on the ISO,
        has a stripped-down <a href="/kernel/">kernel</a> (but still
        provides hardware detection of course) and does not provide a X server.  <a
	...
	<p>grml-medium is an upcoming grml-flavour currently being worked
	on. Its target is to close the gap between grml-small and
	normal/large/full version of grml. grml-medium will be an ISO with
	a maximum ISO size of 200MB. Stay tuned for more details...</p>
...
% grml-lang de    # enter this in the shell to switch keyboard layout
        ...
        <a href="http://www.suckless.org/wiki/dwm">dwm</a>,
...
# readcd -c2scan dev=/dev/cdrom</pre>
        ...
        <ul>
          ...
          <li><a href="http://wiki.grml.org/doku.php?id=grml_1.0">issues regarding
          grml 1.0</a> and</li>

          <li><a href="http://wiki.grml.org/doku.php?id=grml64_0.1">issues
          regarding grml64 0.1</a> in <a href="http://wiki.grml.org/">the
          grml-wiki</a></li>
