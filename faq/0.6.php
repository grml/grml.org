...
#</pre>
        ...
        <p>The grml kernel includes <a href="http://grml.org/kernel/#speakup">support for
        ...
        href="http://grml.org/qemu/">the QEMU-grml-webpage</a>.</p>
        ...
        href="http://grml.org/config/">grml.org/config/</a>, <a
        ...
        href="http://grml.org/files/">'Debian-Information'-section</a> if you are
        ...
        href="http://grml.org/kernel/">full-featured kernel</a>.  grml-small includes
        about 215 software-packages, lacks documentation and manpages on the ISO and
        has a stripped-down <a href="http://grml.org/kernel/">kernel</a> (but still
        ...
        <h3><a name="usb"></a><a href="#toc">How do I boot grml from an USB stick?</a></h3>

        <p>Take a look at the script <a
        href="http://grml.org/scripts/grml2usb">grml2usb</a>. For more details take a
        look at the <a href="http://wiki.grml.org/doku.php?id=usb">usb-webpage in the
        grml-wiki.</a></p>
...
$ grml-lang de    # enter this in the shell to switch keyboard layout
        ...
        <p>grml-terminalserver provides the possibility to boot your system
        ...
        href="http://grml.org/grml2hd/grml2hd.html">man grml2hd</a>').  grml
        ...
        href="http://grml.org/grml2hd/grml2hd.html">man grml2hd</a>.</p>
        ...
        href="http://grml.org/files/grml-cheatcodes.txt">the available
        ...
        href="http://grml.org/contact/">contact us</a>!</p>
        ...
        <p>See /boot/config-`uname -r` and on <a href="http://grml.org/kernel/">the kernel-webpage</a>.</p>
        ...
        href="http://grml.org/zsh/">man zsh-lovers</a>'.</p>
...
/usr/sbin/aideinit</pre>
        ...
        <ul>
          ...
          <li><a href="http://wiki.grml.org/doku.php?id=grml_0.6">issues regarding
          grml 0.6</a> and <a
          href="http://wiki.grml.org/doku.php?id=grml-small_0.2">issues regarding
...
grml-x -module vesa fluxbox        # start fluxbox and use vesa module
        ...
        href="http://grml.org/kernel/#vesafbtng">vesafb-tng</a> instead of
