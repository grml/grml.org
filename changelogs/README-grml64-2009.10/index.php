...
<html>
<head>
<title>grml.org - Release Notes: grml64 2009.10 - Codename Hello-Wien</title>
<meta name="Title" content="grml.org - Release Notes: grml64 2009.10 Hello-Wien" />
<meta name="Author" content="the grml team [grml.org/team/]" />
<meta name="Keywords" content="grml.org, grml" />
<meta name="Description" content="Release Notes of grml64 2009.10" />
...
<?php include '../../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h1>Release Notes for grml64 2009.10 - codename <a
...
<pre class="rahmen">
  aufs drbd8 kqemu loop-aes lzma ndiswrapper speakup squashfs sysprof xtables-addons
        ...
        href="http://wiki.grml.org/doku.php?id=grml64_2009.05">grml64_2009.05 @
...
<pre class="rahmen">
  *2.6.28-grml64* lib*
  ...
  workbone xulrunner-1.9
         ...
         <p>Added 61 new packages (exluding lib* and *2.6.31-grml*):</p>
...
<pre class="rahmen">
  ...
  xulrunner-1.9.1
        ...
        <p>Take a look at <a
        href="http://wiki.grml.org/doku.php?id=grml64_2009.10">grml64_2009.10 @ grml-wiki</a>.
