...
<html>
<head>
<title>grml.org - Release Notes: grml64 0.2-rc1 Schwammerlklauber</title>
...
<?php include '../../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h1>Release Notes:<br />grml64 0.2-rc1 - codename <a
        href="/faq/#releasename">Schwammerlklauber</a> (20070518)</h1>
        ...
        href="http://wiki.grml.org/doku.php?id=grml64_0.1">grml64_0.1 @
        grml-wiki</a>.</p>
...
<pre class="rahmen">
  ...
  yersinia zfs-fuse
         ...
         <p>Take a look at <a
         href="http://wiki.grml.org/doku.php?id=grml64_0.2">grml64_0.2 @ grml-wiki</a>.
         ...
         check <a href="http://wiki.grml.org/doku.php?id=grml64_0.2">grml64_0.2 @
