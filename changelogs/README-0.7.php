...
<html>
<head>
<title>grml.org - Release Notes: grml 0.7 Bootenschnitzl</title>
...
<?php include '../static.inc'; ?>
      ...
      <div class="content">
        ...
        border: 0" src="/screenshots/grml_0.7_small.jpg" width="140" alt="*" /></a></p>

        <h1>Release Notes:<br />grml 0.7 - codename <a
        href="/faq/#releasename">Bootenschnitzl</a> (20060410)</h1>
        ...
        href="http://wiki.grml.org/doku.php?id=grml_0.6">grml_0.6 @
        grml-wiki</a>.</p>
        ...
        <h4><a href="http://wiki.grml.org/doku.php?id=usb">grml2usb</a> (install grml
        to usb stick):</h4>
...
<pre class="rahmen">
  ...
  vaiostat, zd1211
         ...
         example <a href="http://wiki.grml.org/doku.php?id=ati">fglrx</a> and <a
...
<pre class="rahmen">
  ...
  unixcw user-setup
         ...
         href="http://wiki.grml.org/doku.php?id=grml_0.7">grml_0.7 @ grml-wiki</a>
         ...
         check <a href="http://wiki.grml.org/doku.php?id=grml_0.7">grml_0.7 @
