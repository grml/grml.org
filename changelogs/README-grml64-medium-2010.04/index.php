...
<html>
<head>
<title>grml.org - Release Notes: grml64-medium 2010.04 - Codename Grmlmonster</title>
<meta name="Title" content="grml.org - Release Notes: grml64-medium 2010.04 Grmlmonster" />
<meta name="Author" content="the grml team [grml.org/team/]" />
<meta name="Keywords" content="grml.org, grml" />
<meta name="Description" content="Release Notes of grml64-medium 2010.04" />
...
<?php include '../../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h1>Release Notes for grml64-medium 2010.04 - codename <a
...
<pre class="rahmen">
  aufs virtualbox-ose-guest
        ...
        href="/files/release-2010.04-grml-medium64/dpkg_get_selections">dpkg_get_selections</a>
        for a main package listing and <a
          href="/files/release-2010.04-grml-medium64/dpkg_list">dpkg_list</a> for a more
          detailed list of packages shipped with grml64-medium 2010.04.</p>
        ...
        <p>Removed 24 packages (excluding lib* and *2.6.31-grml64*) - please
...
<pre class="rahmen">
  *2.6.31-grml* lib*
  ...
  gcc-4.3-multilib gcc-multilib 
  grml-mercurial-utils grml-scanpartitions hal 
  hal-info linux-libc-dev memtest86+ mercurial 
  mercurial-common openssl-blacklist policykit 
  ttf-dejavu ttf-dejavu-extra 
  xserver-xorg-input-hyperpen
</pre>

         <p>Added 19 new packages (exluding lib* and *2.6.33-grml64*):</p>

<pre class="rahmen">
  apt-xapian-index cpp-4.4 gcc-4.4 genisoimage 
  ...
  ufsutils zerofree
        ...
        <p>Take a look at <a
        href="http://wiki.grml.org/doku.php?id=grml64-medium_2010.04">grml64-medium_2010.04 @ grml-wiki</a>.
        Please report problems using information on <a
          href="/bugs/">grml.org/bugs/</a>.</p>

        <h3>Download grml64-medium 2010.04</h3>

        <p>grml64-medium 2010.04 can be downloaded from the mirrors listed on <a
        ...
        the release please check <a
          href="http://wiki.grml.org/doku.php?id=grml64-medium_2010.04">grml64-medium_2010.04 @
