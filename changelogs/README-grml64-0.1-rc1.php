...
<html>
<head>
<title>grml.org - Release Notes: grml64 0.1 Lifeshell</title>
...
<?php include '../../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h1>Release Notes:<br />grml64 0.1 - codename <a
        href="/faq/#releasename">Lifeshell</a> (20070505)</h1>

        <p><strong>Notice: grml64 0.1-rc1 is a RELEASE CANDIDATE and not
        ...
        <h3>Download grml64 0.1-rc1</h3>

        <p>grml64 0.1-rc1 can be downloaded from mirrors listed on <a
