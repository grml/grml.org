...
<html>
<head>
<title>grml.org - Release Notes: grml64-medium 2009.05 - Codename Lackdose-Allergie</title>
<meta name="Title" content="grml.org - Release Notes: grml64-medium 2009.05 Lackdose-Allergie" />
<meta name="Author" content="the grml team [www.grml.org/team/]" />
<meta name="Keywords" content="grml.org, grml" />
<meta name="Description" content="Release Notes of grml64-medium 2009.05" />
...
<?php include '../../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h1>Release Notes for grml64-medium 2009.05 - codename <a
        ...
        href="http://wiki.grml.org/doku.php?id=grml64-medium_2008.11">grml64-medium_2008.11 @
        ...
        <ul>
          ...
          harddisk. Usage example: 'grml findiso=/grml64-medium_2009.05.iso'
...
<pre class="rahmen">
  aufs lzma squashfs
        ...
        regarding the grml-kernel.</p>
         ...
         href="/files/release-2009.05-grml64-medium/dpkg_get_selections">dpkg_get_selections</a>
         for a main package listing and <a
           href="/files/release-2009.05-grml64-medium/dpkg_list">dpkg_list</a> for a
           more detailed list of packages shipped with grml64-medium 2009.05.</p>
...
<pre class="rahmen">
  *2.6.26-grml* lib*
  ...
  dillo gcc-4.1-base links madwifi-tools x11-utils xserver-xorg-input-elo2300
  ...
  xserver-xorg-video-vga
         ...
         <p>Added 20 new packages (exluding lib* and *2.6.28-grml*):</p>

<pre class="rahmen">
  acl aufs-tools beep console-setup consolekit dbus dstat gcc-4.4-base hal
  hal-info links2 lzop mc moreutils oss-compat pm-utils policykit sensible-utils
  tsconf xserver-common
</pre>
         ...
         <p>Take a look at <a
         href="http://wiki.grml.org/doku.php?id=grml64-medium_2009.05">grml64-medium_2009.05 @ grml-wiki</a>.
         Please report problems using information on <a
           href="/bugs/">grml.org/bugs/</a>.</p>

         <h3>Download grml64-medium 2009.05</h3>

         <p>grml64-medium 2009.05 can be downloaded from the mirrors listed on <a
