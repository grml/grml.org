...
<html>
<head>
<title>grml.org - Release Notes: grml64-medium 2009.10 - Codename Hello-Wien</title>
<meta name="Title" content="grml.org - Release Notes: grml64-medium 2009.10 Hello-Wien" />
<meta name="Author" content="the grml team [grml.org/team/]" />
<meta name="Keywords" content="grml.org, grml" />
<meta name="Description" content="Release Notes of grml64-medium 2009.10" />
...
<?php include '../../static.inc'; ?>
      ...
      <div class="content">
        ...
        <h1>Release Notes for grml64-medium 2009.10 - codename <a
        ...
        ISO-size, <a href="/faq/#whatismedium">grml64-medium</a> tries to close
        ...
        <ul>
          ...
          updates. Check out <a
          href="http://git.grml.org/?p=grml-live.git;a=blob;f=debian/changelog;hb=HEAD">the
        ...
        href="http://wiki.grml.org/doku.php?id=grml64-medium_2009.05">grml64-medium_2009.05 @
        ...
        <p>Details about shipped packages and their versions on grml64-medium are
        available at the <a href="/files/#debian">Debian section</a>. Visit <a
        href="/files/release-2009.10-grml-medium64/dpkg_get_selections">dpkg_get_selections</a>
        for a main package listing and <a
          href="/files/release-2009.10-grml-medium64/dpkg_list">dpkg_list</a> for a more
          detailed list of packages shipped with grml64-medium 2009.10.</p>
        ...
        <p>Removed 7 packages (excluding lib* and *2.6.28-grml64*) - please
...
<pre class="rahmen">
  *2.6.28-grml64* lib*
  ...
  ash diff grml-saveconfig grml-terminalserver-data mktemp timeout vbetool
</pre>

         <p>Added 16 new packages (exluding lib* and *2.6.31-grml64*):</p>

<pre class="rahmen">
  aumix-common diffutils firmware-ralink fontconfig gcc-4.2-base gnupg-curl
  grub-pc install-info iw links mksh scsitools sg3-utils shared-mime-info
  xserver-xorg-input-evtouch xserver-xorg-video-ivtv
        ...
        <p>Take a look at <a
        href="http://wiki.grml.org/doku.php?id=grml64-medium_2009.10">grml64-medium_2009.10 @ grml-wiki</a>.
        Please report problems using information on <a
          href="/bugs/">grml.org/bugs/</a>.</p>

        <h3>Download grml64-medium 2009.10</h3>
        ...
        the release please check <a
          href="http://wiki.grml.org/doku.php?id=grml64-medium_2009.10">grml64-medium_2009.10 @
